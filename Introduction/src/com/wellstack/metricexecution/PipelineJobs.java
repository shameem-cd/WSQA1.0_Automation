package com.wellstack.metricexecution;
...
public class PipelineJobs {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[@title='Metric Execution Management']")).click();
		//Click on Cohort Builder
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[@title='Pipeline Jobs']")).click();
		//Add Cohort
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[contains(text(),'MetricExecution')]")).click();
		Thread.sleep(40000);
		//General Information
		driver.findElement(By.xpath("//input[@name='txtDefinitionName']")).sendKeys("CB TEST FREQUENCY1");
		driver.findElement(By.xpath("//textarea[@placeholder='Enter Description for this definition (Max 500 characters)']")).sendKeys("CB TEST FREQUENCY1");
