...
public class CohortBuilderStatusCodes {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		//General Information
		driver.findElement(By.xpath("//input[@name='txtDefinitionName']")).sendKeys("CB STATUS1");
		driver.findElement(By.xpath("//textarea[@placeholder='Enter Description for this definition (Max 500 characters)']")).sendKeys("CB TEST STATUS1");
