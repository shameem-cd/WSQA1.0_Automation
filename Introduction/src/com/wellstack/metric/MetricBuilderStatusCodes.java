...
public class MetricBuilderStatusCodes {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Expand Report Builder
				...
				Thread.sleep(1000);
				//General Information
				driver.findElement(By.xpath("//input[@name='txtMetricName']")).sendKeys("MB STATUS");
				driver.findElement(By.xpath("//textarea[@placeholder='Enter the Description (Max 500 characters)']")).sendKeys("MB STATUS");
