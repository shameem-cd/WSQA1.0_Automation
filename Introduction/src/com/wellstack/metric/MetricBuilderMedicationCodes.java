...
public class MetricBuilderMedicationCodes {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		//General Information
		driver.findElement(By.xpath("//input[@name='txtMetricName']")).sendKeys("MB MEDICATION");
		driver.findElement(By.xpath("//textarea[@placeholder='Enter the Description (Max 500 characters)']")).sendKeys("CB MEDICATION");
		...
		driver.findElement(By.xpath("//label[@class='ng-tns-c109-22 ui-dropdown-label ui-inputtext ui-corner-all ui-placeholder ng-star-inserted']")).click();
