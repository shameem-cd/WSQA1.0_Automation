...
public class MetricBuilderDiagnosisCodes {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		//General Information
		driver.findElement(By.xpath("//input[@name='txtMetricName']")).sendKeys("MB DAIGNOSIS2");
		driver.findElement(By.xpath("//textarea[@placeholder='Enter the Description (Max 500 characters)']")).sendKeys("CB TEST DAIGNOSIS2");
