...
public class UATCohortBuilderPatientInformation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.findElement(By.cssSelector("body app-root button:nth-child(1)")).click();
		...
		Thread.sleep(1000);
		//General Information
		driver.findElement(By.xpath("//input[@name='txtDefinitionName']")).sendKeys("CB TEST PATIENT INFORMATION");
...
//		driver.findElement(By.xpath("//label[@class='ng-tns-c109-16 ui-dropdown-label ui-inputtext ui-corner-all ng-star-inserted']")).click();
