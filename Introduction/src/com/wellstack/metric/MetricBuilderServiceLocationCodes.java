...
public class MetricBuilderServiceLocationCodes {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		//General Information
		driver.findElement(By.xpath("//input[@name='txtMetricName']")).sendKeys("MB SERLOCATION");
		driver.findElement(By.xpath("//textarea[@placeholder='Enter the Description (Max 500 characters)']")).sendKeys("MB SERLOCATION");
